...
- AWS에 대해 경험이 부족하여 이번 과제를 통해 공부하며 EC2와 ESC에 대해 알아보았습니다.
  
- 서비스에 사용자가 많이 몰리는 등의 이유로 트래픽이 증가 했을때의 대처를 가장 중요하게 생각했습니다.
  
- 예로 추석에 KTX 기차표를 구매하는 경우등을 생각해보았습니다. 특정 기간에 트래픽이 증가하는 경우 AUTO Scaling이라는 기술을 통해 서비스 부하에 대응한다는 점을 배웠습니다.
